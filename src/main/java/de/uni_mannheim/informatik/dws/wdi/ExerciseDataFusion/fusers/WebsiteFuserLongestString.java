 ...
 * 
 */
public class WebsiteFuserLongestString extends AttributeValueFuser<String, Company, Attribute> {

	public WebsiteFuserLongestString() {
	...
	public void fuse(RecordGroup<Company, Attribute> group, Company fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Company.WEBSITE,

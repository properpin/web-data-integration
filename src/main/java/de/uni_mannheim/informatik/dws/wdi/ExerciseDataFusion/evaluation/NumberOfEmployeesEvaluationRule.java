 ...
 * 
 */
public class NumberOfEmployeesEvaluationRule extends EvaluationRule<Company, Attribute> {
...
//not sure if this works!!!!
	...
	public boolean isEqual(Company record1, Company record2, Attribute schemaElement) {
		...
		if(record1.getNumberOfEmployees()==null && record2.getNumberOfEmployees()==null)
			return true;
		else if(record1.getNumberOfEmployees()==null ^ record2.getNumberOfEmployees()==null)
			return false;
		else

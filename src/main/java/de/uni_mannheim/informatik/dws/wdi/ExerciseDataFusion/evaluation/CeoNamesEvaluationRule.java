 ...
 * 
 */
public class CeoNamesEvaluationRule extends EvaluationRule<Company, Attribute> {

	@Override
	public boolean isEqual(Company record1, Company record2, Attribute schemaElement) {
		Set<String> CeoName1 = new HashSet<>();
		List<String> s1=  record1.getCeoNames();
		...
		return CeoName1.containsAll(CeoName2) && CeoName2.containsAll(CeoName1);
	}

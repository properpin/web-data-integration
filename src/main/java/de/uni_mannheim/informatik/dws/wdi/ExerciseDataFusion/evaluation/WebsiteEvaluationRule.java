...
public class WebsiteEvaluationRule extends EvaluationRule<Company, Attribute> {


	@Override
	public boolean isEqual(Company record1, Company record2, Attribute schemaElement) {
		if(record1.getWebsite()== null && record2.getWebsite()==null)
			return true;
		else if(record1.getWebsite()== null ^ record2.getWebsite()==null)
			return false;
		else
